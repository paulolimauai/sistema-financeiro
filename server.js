...
:root{
  --bg:#0D0D11; --sidebar:#121217; --card:#181820; --card-border:rgba(249,115,22,0.30);
  --text:#fafafa; --text-dim:#a1a1aa; --text-faint:#71717a;
  --green:#f97316; --green-soft:rgba(249,115,22,.16);
  --emerald:#f97316; --emerald-soft:rgba(249,115,22,.16);
  --red:#f43f5e; --red-soft:rgba(244,63,94,.15);
  --blue:#fb923c; --purple:#a855f7; --orange:#f97316; --teal:#ea580c; --pink:#ec4899;
  --hover:rgba(249,115,22,.12);
  --radius:16px;
  --shadow:0 16px 40px rgba(0,0,0,.9), 0 0 30px rgba(249,115,22,0.18);
}
body.light, html.light body{
  --bg:#F4F4F6; --sidebar:#ffffff; --card:#ffffff; --card-border:#E4E4E7;
...
/* ==================== Tela de Auth (Cinza Titânio com Laranja Cobre Executivo 4K) ==================== */
.auth-container{
  --auth-accent:#F97316; --auth-accent-2:#EA580C; --auth-accent-3:#FB923C;
  --auth-accent-soft:rgba(249,115,22,.20); --auth-text-on:#0D0D11;
  position:relative; overflow:hidden;
  display:none; align-items:center; justify-content:center; flex-direction:column; min-height:100vh; padding:20px;
  background:
    radial-gradient(circle at 20% 15%, rgba(249,115,22,0.22), transparent 45%),
    radial-gradient(circle at 85% 85%, rgba(245,158,11,0.15), transparent 50%),
    radial-gradient(circle at 50% 50%, rgba(234,88,12,0.12), transparent 65%),
    linear-gradient(135deg, #070709 0%, #0D0D11 40%, #171720 70%, #0A0A0D 100%);
}
...
.auth-box{
  ...
  background:rgba(24,24,32,0.92); border:1.5px solid rgba(249,115,22,0.40); border-radius:24px;
  padding:36px; width:100%; max-width:420px;
  box-shadow:0 30px 70px rgba(0,0,0,0.90), 0 0 45px rgba(249,115,22,0.22), inset 0 1px 1px rgba(255,255,255,0.2);
...
.auth-box .brand .logo{
  background:linear-gradient(135deg,#F97316,#EA580C) !important; color:#0D0D11 !important;
  animation:logoPulse 3s ease-in-out infinite; box-shadow:0 0 20px rgba(249,115,22,0.45);
}
@keyframes logoPulse{
...
.auth-box .field input{
  background:rgba(13,13,17,0.85); border:1px solid rgba(249,115,22,0.25); border-radius:12px;
...
.auth-box .field input:focus, .auth-box .field select:focus{
  border-color:#f97316; box-shadow:0 0 25px rgba(249,115,22,0.35); transform:translateY(-1px);
}
...
.auth-forgot:hover{color:#fb923c; text-decoration:underline;}
.auth-box .btn-auth{
  position:relative; overflow:hidden;
  width:100%; padding:13.5px; background:linear-gradient(135deg, #f97316 0%, #ea580c 50%, #c2410c 100%); color:#0D0D11; border:none;
  ...
  box-shadow:0 10px 28px -4px rgba(249,115,22,0.48), 0 0 20px rgba(249,115,22,0.25);
...
.auth-box .btn-auth:hover{filter:brightness(1.08); transform:translateY(-2px); box-shadow:0 14px 34px -4px rgba(249,115,22,0.6);}
...
.app{
  ...
  background:
    radial-gradient(circle at 12% 0%, rgba(249,115,22,.12), transparent 40%),
    radial-gradient(circle at 88% 18%, rgba(245,158,11,.08), transparent 45%),
    radial-gradient(circle at 50% 100%, rgba(234,88,12,.06), transparent 55%),
    var(--bg);
}
.app.show{display:flex;}
body.light .app{
  background:
    radial-gradient(circle at 12% 0%, rgba(249,115,22,.10), transparent 40%),
    radial-gradient(circle at 88% 18%, rgba(245,158,11,.06), transparent 45%),
    var(--bg);
}
...
.app-blob.a2{width:360px; height:360px; background:#ea580c; bottom:-150px; left:20%; animation:blobFloat 34s ease-in-out infinite; animation-delay:-10s;}
.app-blob.a3{width:300px; height:300px; background:var(--orange); opacity:.08; top:38%; left:-100px; animation:blobFloat 38s ease-in-out infinite; animation-delay:-18s;}
...
.mobile-drawer-nav button {
  ...
  border-radius:12px; background:transparent; border:1px solid transparent; color:#a1a1aa;
...
.mobile-drawer-nav button:hover {
  background:rgba(249,115,22,0.12); color:#fafafa; border-color:rgba(249,115,22,0.28);
}
.mobile-drawer-nav button.active {
  background:linear-gradient(135deg, rgba(249,115,22,0.32) 0%, rgba(234,88,12,0.42) 100%);
  color:#fb923c; font-weight:700; border-color:rgba(251,146,60,0.75);
...
.mobile-drawer-nav button.active .ic {
  background:linear-gradient(135deg, rgba(249,115,22,0.40), rgba(234,88,12,0.30)); color:#fb923c;
}
.mobile-drawer-nav button .ic svg { width:18px; height:18px; display:block; stroke-width:2.2px; }
.brand{display:flex; align-items:center; gap:11px; flex-shrink:0;}
.brand .logo{
  width:42px; height:42px; border-radius:11px; background:linear-gradient(135deg,#F97316,#EA580C);
  display:flex; align-items:center; justify-content:center; font-weight:800; color:#0D0D11; font-size:18px; flex-shrink:0;
  box-shadow:0 0 15px rgba(249,115,22,0.45);
}
.brand .name{font-weight:700; font-size:16px; line-height:1.25; white-space:nowrap;}
.brand .name span{display:block; color:#fb923c; font-size:11px; letter-spacing:.06em; font-weight:700;}
...
nav.menu{
  ...
  background:linear-gradient(180deg, rgba(24,24,32,0.95) 0%, rgba(18,18,23,0.98) 100%);
  border:1px solid rgba(249,115,22,0.32);
  border-radius:18px;
  box-shadow:0 12px 35px -5px rgba(0,0,0,0.8), inset 0 1px 1px rgba(255,255,255,0.1), 0 0 25px rgba(249,115,22,0.14);
...
nav.menu::-webkit-scrollbar-thumb{background:rgba(249,115,22,0.35); border-radius:10px;}
nav.menu::-webkit-scrollbar-thumb:hover{background:rgba(249,115,22,0.6);}
...
.menu button{
  ...
  color:#a1a1aa; padding:8px 14px; border-radius:12px; font-size:13.5px; font-weight:600; letter-spacing:0.015em; cursor:pointer;
  white-space:nowrap; flex-shrink:0; transition:all 0.25s cubic-bezier(0.16, 1, 0.3, 1); user-select:none;
}
.menu button:hover{
  background:rgba(249,115,22,0.12); color:#fafafa; border-color:rgba(249,115,22,0.35);
  transform:translateY(-1px); box-shadow:0 4px 14px rgba(0,0,0,0.35);
}
.menu button.active{
  background:linear-gradient(135deg, rgba(249,115,22,0.32) 0%, rgba(234,88,12,0.42) 100%);
  color:#fb923c; font-weight:700; border:1px solid rgba(251,146,60,0.75);
  box-shadow:0 0 26px rgba(249,115,22,0.45), inset 0 1px 1px rgba(255,255,255,0.3); transform:translateY(-1px);
}
...
.login-success-box{
  background:rgba(24,24,32,0.95); border:1.5px solid rgba(249,115,22,0.45); border-radius:22px;
  padding:38px 32px; width:100%; max-width:360px; text-align:center;
  box-shadow:0 30px 80px rgba(0,0,0,0.95), 0 0 45px rgba(249,115,22,0.25), 0 0 30px rgba(234,88,12,0.15), inset 0 1px 1px rgba(255,255,255,0.2);
...
.login-success-check{
  ...
  background:linear-gradient(135deg, rgba(249,115,22,0.25), rgba(234,88,12,0.20));
  border:1.5px solid rgba(249,115,22,0.5);
  box-shadow:0 0 25px rgba(249,115,22,0.4), inset 0 1px 1px rgba(255,255,255,0.3);
  display:flex; align-items:center; justify-content:center;
}
.login-success-check svg{width:36px; height:36px;}
.login-success-check circle{stroke:#f97316; stroke-width:2.5; opacity:.4;}
...
.login-success-box p{color:#fb923c; font-size:13.5px; font-weight:600;}
