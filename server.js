...
:root{
  --bg:#030706; --sidebar:#050B09; --card:#091510; --card-border:rgba(16,185,129,0.28);
  ...
  --blue:#00E5FF; --purple:#a855f7; --orange:#f59e0b; --teal:#14b8a6; --pink:#ec4899;
  --hover:rgba(16,185,129,.10);
  --radius:16px;
  --shadow:0 16px 40px rgba(0,0,0,.8), 0 0 30px rgba(16,185,129,0.16);
}
...
/* ==================== Tela de Auth (Preto com Esmeralda & Ouro Executivo 4K) ==================== */
.auth-container{
  --auth-accent:#10B981; --auth-accent-2:#059669; --auth-accent-3:#34d399;
  --auth-accent-soft:rgba(16,185,129,.20); --auth-text-on:#030706;
  position:relative; overflow:hidden;
  display:none; align-items:center; justify-content:center; flex-direction:column; min-height:100vh; padding:20px;
  background:
    radial-gradient(circle at 20% 15%, rgba(16,185,129,0.20), transparent 45%),
    ...
    linear-gradient(135deg, #020504 0%, #050d09 40%, #091710 70%, #030706 100%);
}
...
.auth-box{
  ...
  background:rgba(9,21,16,0.88); border:1.5px solid rgba(16,185,129,0.38); border-radius:24px;
  padding:36px; width:100%; max-width:420px;
  box-shadow:0 30px 70px rgba(0,0,0,0.85), 0 0 45px rgba(16,185,129,0.2), inset 0 1px 1px rgba(255,255,255,0.2);
...
.auth-box .brand .logo{
  ...
  animation:logoPulse 3s ease-in-out infinite; box-shadow:0 0 20px rgba(16,185,129,0.4);
}
@keyframes logoPulse{
...
.auth-box .field input{
  background:rgba(5,11,9,0.85); border:1px solid rgba(16,185,129,0.25); border-radius:12px;
...
.auth-box .btn-auth{
  position:relative; overflow:hidden;
  width:100%; padding:13.5px; background:linear-gradient(135deg, #10b981 0%, #059669 50%, #047857 100%); color:#fff; border:none;
...
.app{
  ...
  background:
    ...
    radial-gradient(circle at 50% 100%, rgba(16,185,129,.05), transparent 55%),
    var(--bg);
}
.app.show{display:flex;}
body.light .app{
  background:
    radial-gradient(circle at 12% 0%, rgba(16,185,129,.08), transparent 40%),
...
.mobile-drawer-nav button:hover {
  background:rgba(16,185,129,0.09); color:#f8fafc; border-color:rgba(16,185,129,0.22);
}
.mobile-drawer-nav button.active {
  background:linear-gradient(135deg, rgba(16,185,129,0.28) 0%, rgba(5,150,105,0.35) 100%);
  color:#34d399; font-weight:700; border-color:rgba(52,211,153,0.65);
...
.mobile-drawer-nav button.active .ic {
  background:linear-gradient(135deg, rgba(16,185,129,0.35), rgba(5,150,105,0.25)); color:#34d399;
}
...
nav.menu{
  ...
  background:linear-gradient(180deg, rgba(9,21,16,0.92) 0%, rgba(5,11,9,0.98) 100%);
  border:1px solid rgba(16,185,129,0.28);
  border-radius:18px;
  box-shadow:0 12px 35px -5px rgba(0,0,0,0.7), inset 0 1px 1px rgba(255,255,255,0.1), 0 0 25px rgba(16,185,129,0.12);
...
.menu button:hover{
  background:rgba(16,185,129,0.12); color:#f8fafc; border-color:rgba(16,185,129,0.35);
...
.menu button.active{
  ...
  box-shadow:0 0 26px rgba(16,185,129,0.42), inset 0 1px 1px rgba(255,255,255,0.3); transform:translateY(-1px);
}
