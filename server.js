...
:root{
  --bg:#080B15; --sidebar:#0E1322; --card:#13192B; --card-border:rgba(200,155,60,0.45);
  --text:#ffffff; --text-dim:#8E9BAE; --text-faint:#5C6B80;
  ...
  --radius:18px;
  --shadow:0 16px 40px rgba(0,0,0,.92), 0 0 30px rgba(200,155,60,0.22);
}
...
/* ==================== Tela de Auth (Executivo Ouro & Azul Aço - Imagem de Referência 4K) ==================== */
.auth-container{
  ...
  background:
    radial-gradient(circle at 20% 15%, rgba(229,169,60,0.20), transparent 45%),
    radial-gradient(circle at 85% 85%, rgba(91,148,217,0.18), transparent 50%),
    radial-gradient(circle at 50% 50%, rgba(200,155,60,0.12), transparent 65%),
    linear-gradient(135deg, #05070E 0%, #080B15 40%, #0E1322 70%, #0A0D18 100%);
}
...
.auth-grid{
  ...
  background-image:
    ...
    linear-gradient(90deg, rgba(91,148,217,.08) 1px, transparent 1px);
...
.auth-box{
  ...
  background:rgba(14,19,34,0.95); border:1.5px solid rgba(200,155,60,0.60); border-radius:28px;
  padding:38px; width:100%; max-width:420px;
  box-shadow:0 35px 80px rgba(0,0,0,0.95), 0 0 45px rgba(200,155,60,0.28), inset 0 1px 1px rgba(255,255,255,0.25);
...
.auth-box .field input{
  ...
  padding:14px 16px; color:#fff; transition:border-color .25s, box-shadow .25s, transform .15s;
}
...
.app{
  ...
  background:
    radial-gradient(circle at 12% 0%, rgba(229,169,60,.14), transparent 40%),
    radial-gradient(circle at 88% 18%, rgba(91,148,217,.12), transparent 45%),
    radial-gradient(circle at 50% 100%, rgba(200,155,60,.06), transparent 55%),
    var(--bg);
}
.app.show{display:flex;}
body.light .app{
  background:
    radial-gradient(circle at 12% 0%, rgba(229,169,60,.10), transparent 40%),
    radial-gradient(circle at 88% 18%, rgba(91,148,217,.06), transparent 45%),
    var(--bg);
}
...
.app-bg-grid{
  ...
  background-image:
    ...
    linear-gradient(90deg, rgba(91,148,217,.06) 1px, transparent 1px);
  background-size:54px 54px;
...
.app-blob.a2{width:360px; height:360px; background:#5B94D9; bottom:-150px; left:20%; animation:blobFloat 34s ease-in-out infinite; animation-delay:-10s;}
...
.mobile-drawer-nav button {
  ...
  border-radius:12px; background:transparent; border:1px solid transparent; color:#8E9BAE;
...
.mobile-drawer-nav button:hover {
  background:rgba(229,169,60,0.14); color:#ffffff; border-color:rgba(200,155,60,0.30);
}
.mobile-drawer-nav button.active {
  background:linear-gradient(90deg, rgba(229,169,60,0.35) 0%, rgba(91,148,217,0.45) 100%);
  color:#f5c26b; font-weight:700; border-color:rgba(200,155,60,0.75);
  box-shadow:0 0 22px rgba(229,169,60,0.38);
}
...
.mobile-drawer-nav button.active .ic {
  background:linear-gradient(135deg, rgba(229,169,60,0.42), rgba(91,148,217,0.32)); color:#f5c26b;
}
.mobile-drawer-nav button .ic svg { width:18px; height:18px; display:block; stroke-width:2.2px; }
.brand{display:flex; align-items:center; gap:11px; flex-shrink:0;}
.brand .logo{
  width:42px; height:42px; border-radius:12px; background:linear-gradient(135deg,#E6C675 0%, #D4A84B 45%, #76A5D9 100%);
  display:flex; align-items:center; justify-content:center; font-weight:900; color:#0A0D18; font-size:19px; flex-shrink:0;
  box-shadow:0 0 15px rgba(200,155,60,0.5);
}
.brand .name{font-weight:700; font-size:16px; line-height:1.25; white-space:nowrap;}
.brand .name span{display:block; color:#E5A93C; font-size:11px; letter-spacing:.06em; font-weight:700;}
...
nav.menu{
  ...
  background:linear-gradient(180deg, rgba(14,19,34,0.95) 0%, rgba(8,11,21,0.98) 100%);
  border:1px solid rgba(200,155,60,0.45);
  border-radius:18px;
  box-shadow:0 12px 35px -5px rgba(0,0,0,0.85), inset 0 1px 1px rgba(255,255,255,0.15), 0 0 25px rgba(200,155,60,0.18);
...
nav.menu::-webkit-scrollbar-thumb{background:rgba(200,155,60,0.38); border-radius:10px;}
nav.menu::-webkit-scrollbar-thumb:hover{background:rgba(200,155,60,0.65);}
...
.menu button{
  ...
  color:#8E9BAE; padding:8px 14px; border-radius:12px; font-size:13.5px; font-weight:600; letter-spacing:0.015em; cursor:pointer;
  white-space:nowrap; flex-shrink:0; transition:all 0.25s cubic-bezier(0.16, 1, 0.3, 1); user-select:none;
}
.menu button:hover{
  background:rgba(229,169,60,0.14); color:#ffffff; border-color:rgba(200,155,60,0.35);
  transform:translateY(-1px); box-shadow:0 4px 14px rgba(0,0,0,0.35);
}
.menu button.active{
  background:linear-gradient(90deg, rgba(229,169,60,0.35) 0%, rgba(91,148,217,0.45) 100%);
  color:#ffffff; font-weight:700; border:1px solid rgba(200,155,60,0.85);
  box-shadow:0 0 26px rgba(200,155,60,0.48), inset 0 1px 1px rgba(255,255,255,0.4); transform:translateY(-1px);
}
.menu button.active::after{
  content:''; position:absolute; bottom:-2px; left:20%; right:20%; height:2.5px;
  background:linear-gradient(90deg, transparent, #E5A93C, #5B94D9, transparent); border-radius:999px; box-shadow:0 0 12px #E5A93C;
}
.menu button .ic{
  width:24px; height:24px; border-radius:8px; background:rgba(255,255,255,0.04);
  display:inline-flex; align-items:center; justify-content:center; flex-shrink:0; transition:all 0.25s ease;
}
.menu button:hover .ic{background:rgba(229,169,60,0.22); color:#f5c26b;}
.menu button.active .ic{
  background:linear-gradient(135deg, rgba(229,169,60,0.48), rgba(91,148,217,0.35)); color:#ffffff; box-shadow:0 0 14px rgba(200,155,60,0.5);
}
.menu button .ic svg, .icon-btn svg{width:17px; height:17px; display:block; stroke-width:2.2px;}
.menu button.active .ic svg{filter:drop-shadow(0 0 5px rgba(229,169,60,0.8));}
.menu button.active::after{
  content:''; position:absolute; bottom:-2px; left:20%; right:20%; height:2.5px;
...
.kpi{
  ...
  border:1.5px solid rgba(59,130,246,0.32); border-radius:18px; padding:20px 18px;
...
.kpi:hover{
  ...
  box-shadow:0 22px 45px rgba(0,0,0,0.8), 0 0 30px rgba(59,130,246,0.32), inset 0 1px 1px rgba(255,255,255,0.25);
}
...
.kpi .ic{
  ...
  box-shadow:0 4px 14px rgba(0,0,0,0.4), inset 0 1px 1px rgba(255,255,255,0.2);
...
.kpi .sub.up{color:#60a5fa; font-weight:700;}
...
body.light .kpi::before { background:linear-gradient(90deg, #1e3a8a, #2563eb); }
...
.panel{
  position:relative; overflow:hidden;
  background:linear-gradient(145deg, rgba(17,28,58,0.92) 0%, rgba(11,19,43,0.96) 100%);
  border:1.5px solid rgba(59,130,246,0.32); border-radius:20px; padding:22px;
  box-shadow:0 14px 35px rgba(0,0,0,0.65), inset 0 1px 1px rgba(255,255,255,0.15);
  backdrop-filter:blur(24px); -webkit-backdrop-filter:blur(24px);
  transition:all 0.3s cubic-bezier(0.16, 1, 0.3, 1);
}
.panel:hover{
  border-color:rgba(59,130,246,0.55);
  box-shadow:0 18px 40px rgba(0,0,0,0.75), 0 0 25px rgba(59,130,246,0.20);
}
...
.panel-head .tag{font-size:12px; font-weight:600; color:var(--text-dim); background:rgba(59,130,246,0.12); padding:6px 12px; border-radius:10px; cursor:pointer; border:1px solid rgba(59,130,246,0.25); transition:all 0.2s ease;}
.panel-head .tag:hover{background:rgba(59,130,246,0.25); color:#ffffff; border-color:rgba(96,165,250,0.5);}
...
.acc-row{
  ...
  background:rgba(8,14,33,0.6); border:1px solid rgba(59,130,246,0.18);
  transition:all 0.25s cubic-bezier(0.16, 1, 0.3, 1);
}
.acc-row:hover{
  background:rgba(59,130,246,0.15); border-color:rgba(59,130,246,0.45);
  transform:translateX(3px); box-shadow:0 4px 16px rgba(0,0,0,0.3);
}
.acc-row:hover .acc-edit{opacity:1;}
.acc-ic{width:44px; height:44px; border-radius:12px; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:14px; flex-shrink:0; color:#fff; box-shadow:0 4px 12px rgba(0,0,0,.35);}
.acc-info{flex:1; min-width:0;}
.acc-info .n{font-size:13px; font-weight:700; color:#ffffff;}
.acc-info .t{font-size:11px; color:var(--text-faint);}
.acc-val{font-size:13px; font-weight:800; white-space:nowrap; color:#60a5fa;}
...
.table-panel{
  position:relative;
  background:linear-gradient(145deg, rgba(17,28,58,0.94) 0%, rgba(11,19,43,0.96) 100%);
  border:1.5px solid rgba(59,130,246,0.32); border-radius:20px; padding:22px; overflow-x:auto;
  box-shadow:0 14px 35px rgba(0,0,0,0.65), inset 0 1px 1px rgba(255,255,255,0.15);
  backdrop-filter:blur(24px); -webkit-backdrop-filter:blur(24px);
}
...
td{padding:13px 12px; font-size:13px; border-top:1px solid rgba(59,130,246,0.18);}
tr.trow:hover td{background:rgba(59,130,246,0.10);}
...
.status-pago{background:rgba(59,130,246,0.18); color:#60a5fa; border:1px solid rgba(59,130,246,0.35);}
.status-recebido{background:rgba(59,130,246,0.18); color:#60a5fa; border:1px solid rgba(59,130,246,0.35);}
.status-pendente{background:rgba(245,158,11,.16); color:#f59e0b; border:1px solid rgba(245,158,11,0.35);}
.val-in{color:#60a5fa; font-weight:800;}
.val-out{color:var(--red); font-weight:800;}
.type-ic.in{color:#60a5fa; font-weight:800;}
...
.row-actions button:hover{background:rgba(59,130,246,0.22); color:#ffffff; border-color:rgba(96,165,250,0.5);}
...
.cat-manage-tabs .cat-tab.active{background:linear-gradient(135deg, rgba(59,130,246,0.3), rgba(37,99,235,0.4)); color:#60a5fa; border-color:rgba(96,165,250,0.7);}
...
.filters input:focus, .filters select:focus{border-color:#3b82f6; box-shadow:0 0 15px rgba(59,130,246,0.3);}
...
.cat-card{
  background:linear-gradient(145deg, rgba(17,28,58,0.92) 0%, rgba(11,19,43,0.96) 100%);
  border:1.5px solid rgba(59,130,246,0.30); border-radius:16px; padding:18px; display:flex; flex-direction:column;
  box-shadow:0 10px 26px rgba(0,0,0,0.5), inset 0 1px 1px rgba(255,255,255,0.15);
  transition:all 0.3s cubic-bezier(0.16, 1, 0.3, 1);
}
.cat-card:hover{
  transform:translateY(-3px) scale(1.02);
  border-color:rgba(96,165,250,0.65);
  box-shadow:0 18px 36px rgba(0,0,0,0.7), 0 0 22px rgba(59,130,246,0.25);
}
...
.cat-card .amt{font-size:18px; font-weight:800; color:#60a5fa;}
...
.cat-card-add{
  border:1.5px dashed rgba(59,130,246,0.4); background:rgba(59,130,246,0.04); cursor:pointer;
  border-radius:16px; padding:18px;
  display:flex; flex-direction:column; align-items:center; justify-content:center; gap:6px;
  color:var(--text-dim); font-size:13px; font-weight:700; min-height:100px; font-family:inherit;
  transition:all 0.25s cubic-bezier(0.16, 1, 0.3, 1);
}
.cat-card-add:hover{border-color:#3b82f6; color:#60a5fa; background:rgba(59,130,246,0.12); transform:translateY(-2px);}
...
.login-success-box{
  background:rgba(17,28,58,0.95); border:1.5px solid rgba(59,130,246,0.45); border-radius:22px;
  padding:38px 32px; width:100%; max-width:360px; text-align:center;
  box-shadow:0 30px 80px rgba(0,0,0,0.95), 0 0 45px rgba(59,130,246,0.28), 0 0 30px rgba(37,99,235,0.20), inset 0 1px 1px rgba(255,255,255,0.3);
...
.login-success-check{
  ...
  box-shadow:0 0 25px rgba(59,130,246,0.45), inset 0 1px 1px rgba(255,255,255,0.4);
  display:flex; align-items:center; justify-content:center;
}
.login-success-check svg{width:36px; height:36px;}
.login-success-check circle{stroke:#3b82f6; stroke-width:2.5; opacity:.4;}
.login-success-check path{
  stroke:#60a5fa; stroke-width:4; stroke-linecap:round; stroke-linejoin:round;
